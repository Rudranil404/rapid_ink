...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 sticky-mobile-action">
        <div class="d-flex align-items-center gap-3">
            ...
            <h4 class="fw-bold mb-0 d-none d-md-block">Product Details</h4>
            <span class="d-md-none text-muted small fw-bold text-uppercase">New Product</span>
        </div>
        <div>
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="form-card">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="variant-checkbox"><input type="checkbox" id="size-xs" name="sizes[]" value="XS"><label for="size-xs">XS</label></div>
                        <div class="variant-checkbox"><input type="checkbox" id="size-s" name="sizes[]" value="S"><label for="size-s">S</label></div>
                        <div class="variant-checkbox"><input type="checkbox" id="size-m" name="sizes[]" value="M"><label for="size-m">M</label></div>
                        <div class="variant-checkbox"><input type="checkbox" id="size-l" name="sizes[]" value="L" checked><label for="size-l">L</label></div>
                        <div class="variant-checkbox"><input type="checkbox" id="size-xl" name="sizes[]" value="XL"><label for="size-xl">XL</label></div>
                        <div class="variant-checkbox"><input type="checkbox" id="size-xxl" name="sizes[]" value="XXL"><label for="size-xxl">XXL</label></div>
                    </div>
                    <div>
                        <label class="form-label d-block mb-3">Available Colors</label>
                        <div class="variant-checkbox"><input type="checkbox" id="color-black" name="colors[]" value="Black" checked><label for="color-black">Black</label></div>
                        <div class="variant-checkbox"><input type="checkbox" id="color-white" name="colors[]" value="White"><label for="color-white">White</label></div>
                        <div class="variant-checkbox"><input type="checkbox" id="color-gray" name="colors[]" value="Heather Gray"><label for="color-gray">Gray</label></div>
                        <div class="variant-checkbox"><input type="checkbox" id="color-custom" name="colors[]" value="Custom"><label for="color-custom">Custom +</label></div>
                    </div>
                </div>
            </div>
